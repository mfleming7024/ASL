<div id="middle_two" class="clearfix">
    ...
    <nav id="admin_nav">
        <ul id="upload_bar">
        <a id="back_btn" style="color: white; font-family: 'Titillium Web', sans-serif; margin-top: -4px;" href="/user/album/<?php echo $this->session->userdata('viewedUserId'); ?>">&#60; Back</a>
